!function(e,t){"object"==typeof exports&&"undefined"!=typeof module?t(exports,require("@angular/core"),require("@angular/common"),require("rxjs/operators")):"function"==typeof define&&define.amd?define("@pedixapp/preboot",["exports","@angular/core","@angular/common","rxjs/operators"],t):t(((e="undefined"!=typeof globalThis?globalThis:e||self).pedixapp=e.pedixapp||{},e.pedixapp.preboot={}),e.ng.core,e.ng.common,e.rxjs.operators)}(this,(function(e,t,n,o){"use strict";function r(e){for(var t=[],n=e.root,o=e.node,r=o;r&&r!==n.serverNode&&r!==n.clientNode;)t.push(r),r=r.parentNode;r&&t.push(r);for(var i=o.nodeName||"unknown",a=t.length-1;a>=0;a--)if((r=t[a]).childNodes&&a>0)for(var l=0,c=0;l<r.childNodes.length;l++)if(8!==r.childNodes[l].nodeType&&c++,r.childNodes[l]===t[a-1]){i+="_s"+c;break}return i}
/**
     * @license
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var T="preboot-inline-script",x=new t.InjectionToken("PrebootOptions");function P(e,t,n){var o=e.createElement("script");return t&&(o.nonce=t),o.className=T,o.textContent=n,o}function R(e,t,r,i,a,l){return function(){if(O(t),n.isPlatformServer(i)){var c=w(t),s=P(e,r,c),u=e.getElementsByClassName(T);if(0===u.length){var d=[].concat(t.appRoot);e.head.appendChild(s),d.map((function(t){return{selector:t,appRootElem:e.querySelector(t)}})).forEach((function(t){var n=t.selector,o=t.appRootElem;if(o){var i=P(e,r,"prebootInitFn();");o.insertBefore(i,o.firstChild)}else console.log("No server node found for selector: "+n)}))}else u.length>0&&r&&(u[0].nonce=r)}n.isPlatformBrowser(i)&&((null==t.replay||t.replay)&&a.isStable.pipe(o.filter((function(e){return e})),o.take(1)).subscribe((function(){l.replayAll()})))}}var k={provide:t.APP_BOOTSTRAP_LISTENER,useFactory:R,deps:[n.DOCUMENT,x,[new t.Optional,new t.Inject(i)],t.PLATFORM_ID,t.ApplicationRef,c],multi:!0},A=function(){function e(){}return e.withConfig=function(t){return{ngModule:e,providers:[{provide:x,useValue:t}]}},e}();
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */A.decorators=[{type:t.NgModule,args:[{providers:[c,k]}]}],
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
